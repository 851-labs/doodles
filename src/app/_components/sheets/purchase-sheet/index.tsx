    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="w-[420px]">
        <div className="mx-auto flex size-12 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800">
          <Sparkles className="size-6 text-gray-600 dark:text-gray-400" />
        </div>
        <DialogTitle>Get More Doodles</DialogTitle>
        <DialogDescription>Credits never expire. Use them whenever you want.</DialogDescription>
